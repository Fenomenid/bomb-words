    ...
    <div className="modal-backdrop" role="dialog" aria-modal="true" aria-label="Правила игры">
      <section className="rules-modal">
        ...
        <div className="rules-list">
          <section>
            <h3>Цель</h3>
            <p>Объяснить слово так, чтобы его угадали, и не произнести мины. В конце побеждает игрок с наибольшим количеством очков.</p>
          </section>
          <section>
            <h3>Раунд</h3>
            <ul>
              <li>Сервер выбирает объясняющего и угадывающего. Остальные становятся минерами.</li>
              <li>Минеры видят слово и добавляют мины. Объясняющий и угадывающий список мин не видят.</li>
              <li>Когда мины готовы или таймер вышел, начинается объяснение.</li>
            </ul>
          </section>
          <section>
            <h3>Мины</h3>
            <ul>
              <li>Мина должна быть связана со словом или его ассоциациями.</li>
              <li>Не используйте служебные слова: предлоги, местоимения, междометия, обычные “да”, “нет”, “угу”.</li>
              <li>Не ставьте пустые слова для общения: “смотри”, “давай”, “готов”, “понял”, если они не связаны со словом.</li>
              <li>Не ставьте аббревиатуры. Лучше разложить их на отдельные слова.</li>
            </ul>
          </section>
          <section>
            <h3>Объяснение</h3>
            <ul>
              <li>Объясняющий и угадывающий избегают мин и однокоренных слов.</li>
              <li>Нельзя объяснять слово по буквам, слогам, ребусами, анаграммами или “переверни слово”.</li>
              <li>Нельзя обходить мину прямым переводом на другой язык. Заимствованные слова использовать можно.</li>
              <li>Можно говорить о длине, роде, происхождении и сложности слова.</li>
            </ul>
          </section>
          <section>
            <h3>Очки</h3>
            <ul>
              <li>Слово угадано: объясняющий и угадывающий получают +1.</li>
              <li>Слово не угадано или время вышло: объясняющий и угадывающий получают -1.</li>
              <li>Каждая сработавшая мина: объясняющий и угадывающий получают еще -1, автор мины получает +1.</li>
            </ul>
          </section>
        </div>
      </section>
